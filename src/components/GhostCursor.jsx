...
const GhostCursor = ({
  ...
  const fragmentShader = `
    ...
    vec4 blob(vec2 p, vec2 mousePos, float intensity, float activity) {
      ...
      float radius = (0.5 + 0.3 * (1.0 / iScale)) * iRadiusScale;
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      material.uniforms.iScale.value = calculateScale(host) * blobScale;
